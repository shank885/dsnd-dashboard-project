...
from employee_events import Team, Employee
...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        ax.set_title('Cummulative Event Counts', fontsize=20)
